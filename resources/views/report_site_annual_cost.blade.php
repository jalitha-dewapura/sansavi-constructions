...
<div>
    <br>
    <h2 class="ml-5">Annual Material Cost of The Site</h2>
    <hr>
    <br>
</div>
...
<div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-body -->
                <div class="card-body">
                    <form class="form-horizontal" action="{{route('report_site_annual_cost.generate')}}" method="post" autocomplete="off"> 
                        @csrf
                        <div class="form-group row d-flex justify-content-center">
                            ...
                            <div class="col-md-4">
                                <select class="w-100" id="site" name="site" required>
